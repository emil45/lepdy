# Requirements Archive: v1.4 Complete Puzzle Experience
...
- [x] **PROG-02**: User sees a per-piece breakdown on the session complete screen (which pieces practiced, how many correct)
